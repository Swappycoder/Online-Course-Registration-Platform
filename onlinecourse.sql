...
('10806121', '', 'f925916e2754e5e03f75dd58a5733251', 'Hanmant Magar', '822894', NULL, NULL, NULL, '7.10', '2022-02-11 00:53:31', NULL);
...
BEGIN
  IF NEW.password = OLD.password THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'New password cannot be same as old password';
  END IF;
END$$
DELIMITER ;
